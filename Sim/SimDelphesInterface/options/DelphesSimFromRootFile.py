...
inputRootFile="FCCDelphesOutput.root"
if args.inputfile != '':
    inputRootFile = args.inputfile
...
podioInput = PodioInput("PodioReader", collections=["all_genvertices", "all_genparticles"], OutputLevel=INFO)
...
############################################################
# Run Pythia + Delphes
ApplicationMgr( TopAlg = [ podioInput, hepmc_converter, delphessim, out ],
                EvtSel = 'NONE',
                EvtMax = nEvents,
                ExtSvc = [podioEvent])
